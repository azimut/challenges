...
var $author$project$LuciansLusciousLasagna$elapsedTimeInMinutes = F2(
	function (layers, cookedTime) {
		return $author$project$LuciansLusciousLasagna$preparationTimeInMinutes(layers) + cookedTime;
	});
...
var pipeFilename = "/tmp/elm_test-866513.sock";
var net = require('net'),
