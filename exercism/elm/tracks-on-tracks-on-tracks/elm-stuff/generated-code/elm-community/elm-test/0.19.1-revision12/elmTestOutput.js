...
var $author$project$TracksOnTracksOnTracks$excitingList = function (languages) {
	_v0$0:
	while (true) {
		_v0$3:
		while (true) {
			if (languages.b) {
				if (languages.b.b && (languages.b.a === 'Elm')) {
					if (!languages.b.b.b) {
						if (languages.a === 'Elm') {
							break _v0$0;
						} else {
		...
		[
			...
			_List_fromArray(
				[
					...
					'newList should return an empty list',
					function (_v0) {
						return A2($elm_explorations$test$Expect$equal, _List_Nil, $author$project$TracksOnTracksOnTracks$newList);
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'existingList should return Elm, Clojure and Haskell',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								['Elm', 'Clojure', 'Haskell']),
							$author$project$TracksOnTracksOnTracks$existingList);
					}),
					A2(
					$elm_explorations$test$Test$test,
					'addLanguage adds language to empty list',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								['Scala']),
							A2($author$project$TracksOnTracksOnTracks$addLanguage, 'Scala', $author$project$TracksOnTracksOnTracks$newList));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'addLanguage adds language to existing list',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								['Common Lisp', 'Elm', 'Clojure', 'Haskell']),
							A2($author$project$TracksOnTracksOnTracks$addLanguage, 'Common Lisp', $author$project$TracksOnTracksOnTracks$existingList));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'addLanguage adds language to custom list',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								['Racket', 'Scheme']),
							A2(
								$author$project$TracksOnTracksOnTracks$addLanguage,
								'Racket',
								_List_fromArray(
									['Scheme'])));
					})
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'Count languages on new list',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							0,
							$author$project$TracksOnTracksOnTracks$countLanguages($author$project$TracksOnTracksOnTracks$newList));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Count languages on existing list',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							3,
							$author$project$TracksOnTracksOnTracks$countLanguages($author$project$TracksOnTracksOnTracks$existingList));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Count languages on custom list',
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							2,
							$author$project$TracksOnTracksOnTracks$countLanguages(
								_List_fromArray(
									['Python', 'JavaScript'])));
					})
				])),
				...
				[
					...
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_Nil,
							$author$project$TracksOnTracksOnTracks$reverseList($author$project$TracksOnTracksOnTracks$newList));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Reverse order of existing list',
					function (_v9) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$List$reverse($author$project$TracksOnTracksOnTracks$existingList),
							$author$project$TracksOnTracksOnTracks$reverseList($author$project$TracksOnTracksOnTracks$existingList));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v10) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								['Clojure', 'Scala', 'Java', 'Kotlin']),
							$author$project$TracksOnTracksOnTracks$reverseList(
								_List_fromArray(
									['Kotlin', 'Java', 'Scala', 'Clojure'])));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'Empty list is not exciting',
					function (_v11) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							$author$project$TracksOnTracksOnTracks$excitingList(_List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Singleton list with Elm is exciting',
					function (_v12) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							$author$project$TracksOnTracksOnTracks$excitingList(
								_List_fromArray(
									['Elm'])));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Singleton list without Elm is not exciting',
					function (_v13) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Two-item list with Elm as first item is exciting',
					function (_v14) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Two-item list with Elm as second item is exciting',
					function (_v15) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Two-item list without Elm is not exciting',
					function (_v16) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Three-item list with Elm as first item is exciting',
					function (_v17) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Three-item list with Elm as second item is exciting',
					function (_v18) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Three-item list with Elm as third item is not exciting',
					function (_v19) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Four-item list with Elm as first item is exciting',
					function (_v20) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Four-item list with Elm as second item is not exciting',
					function (_v21) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Four-item list with Elm as third item is not exciting',
					function (_v22) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
					...
					A2(
					$elm_explorations$test$Test$test,
					'Four-item list with Elm as fourth item is not exciting',
					function (_v23) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
...
var pipeFilename = "/tmp/elm_test-879157.sock";
var net = require('net'),
