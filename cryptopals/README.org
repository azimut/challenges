...
*** Break repeating-key XOR
  ...
  - What?
    ...
    - That represents *repeating-key* XOR english message.
    - I need to figure out the more likely length of the key using *hamming distance*
    - And bruteforce the key, by bruteforcing each XOR digit one at the time.
  - How?
