...
module Tests = struct
  ...
  let testBestSum(t: int) (k: int) (ls: int list) (expectedOutput: int) =
    ...
    print_string "input "; print_int t;
    print_string "\n";
    print_int(k);
    print_string "\n";
    print_list ls;
    print_string "\n";
    print_string "Expected "; print_int expectedOutput; print_endline "\n got ";
    print_int act; print_endline "\n-----"; print_endline "";
  ...
  let suite = [
      "smallest" >:::
        [
          "Basic tests" >:: (fun _ ->
            testBestSum 230 3
              [91; 74; 73; 85; 73; 81; 87] 228;
            testBestSum 331 2
              [91; 74; 73; 85; 73; 81; 87] 178;
            testBestSum 331 4
              [91; 74; 73; 85; 73; 81; 87] 331;
            testBestSum 331 5
              [91; 74; 73; 85; 73; 81; 87] (-1);
          );
        ]
    ]
end
